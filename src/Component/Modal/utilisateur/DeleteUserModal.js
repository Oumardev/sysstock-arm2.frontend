...
const DeleteUserModal = ({dataModal: {id}, setShowModal}) =>{
        ...
        <React.Fragment>
            ...
            <div className="modal-dialog modal-dialog-centered" role="document">
                ...
                <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalLongTitle">Supprimer un utilisateur</h5>
                ...
                <div className="modal-body" style={modalStyle.body}>
                    <div style={modalStyle.content_form}>
                        <p style={{color:'red'}}>Voulez vous vraiment supprimer cet utilisateur ?</p>
                    </div>
                </div>
