...
function AddPrixMarcheModal({setShowModal}) {
    ...
    const addPrixMarcheSchema = Yup.object().shape({
        variete: Yup.string()
          .min(1, 'Trop court!')
          .max(100, 'Trop long!')
        ...
        <React.Fragment>
            ...
            <div className="modal-dialog" role="document">
                ...
                <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalLabel">Ajouter un prix marche</h5>
                ...
                <Formik
                    ...
                    validationSchema = {addPrixMarcheSchema}
                    ...
                    <Form>
                        ...
                        <div className="row">  
                            ...
                            <div class="input-group mt-3">
                                ...
                                <select value={values.region} onChange={handleChange}  onBlur={handleBlur} id="marche" name="marche" class="custom-select">
                        ...
                        <div className="row">
                            <div class="input-group mt-3">
                                ...
                                <select value={values.region} onChange={handleChange}  onBlur={handleBlur} id="sac_demigros" name="sac_demigros" class="custom-select">
...
export default AddPrixMarcheModal