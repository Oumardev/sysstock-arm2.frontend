...
import { deletePrixMarche } from '../../../slices/marcheSlice'
        ...
        <React.Fragment>
            ...
            <div className="modal-dialog modal-dialog-centered" role="document">
                ...
                <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalLongTitle">Supprimer un prix marché</h5>
                ...
                <div className="modal-body" style={modalStyle.body}>
                    <div style={modalStyle.content_form}>
                        <p style={{color:'red'}}>Voulez vous vraiment supprimer ce prix marché ?</p>
                    </div>
                </div>
