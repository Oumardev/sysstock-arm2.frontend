...
function AddMarcheModal({setShowModal}) {
        ...
        <React.Fragment>
            ...
            <div className="modal-dialog" role="document">
                ...
                <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalLabel">Ajouter un marché</h5>
                ...
                <Formik
                    ...
                    onSubmit={(values, { setSubmitting }) => {
                        ...
                        const formatData = {nom: values.nom, superficie: values.superficie, frequence: values.frequence, zone_id: zone_id}
                        // add marche
                        
                        dispatch(addMarche(formatData))
                        setShowModal(false)
