...
import { deleteVariete } from '../../../slices/varieteSlice'
...
const DeleteVarieteModal = ({dataModal: {id}, setShowModal}) =>{

    const dispatch = useDispatch()

    const handleDelete = () =>{
        
        dispatch(deleteVariete(id))
        setShowModal(false)
        ...
        <React.Fragment>
            ...
            <div className="modal-dialog modal-dialog-centered" role="document">
                ...
                <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalLongTitle">Supprimer une variété</h5>
                ...
                <div className="modal-body" style={modalStyle.body}>
                    <div style={modalStyle.content_form}>
                        <p style={{color:'red'}}>Voulez vous vraiment supprimer cet variété ?</p>
                    </div>
                </div>
...
export default DeleteVarieteModal