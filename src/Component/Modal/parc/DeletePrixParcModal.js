...
import { deletePrixParc } from '../../../slices/parcSlice'
...
const DeletePrixParcModal = ({dataModal: {id}, setShowModal}) =>{

    const dispatch = useDispatch()

    const handleDelete = () =>{
        
        dispatch(deletePrixParc(id))
        setShowModal(false)
        ...
        <React.Fragment>
            ...
            <div className="modal-dialog modal-dialog-centered" role="document">
                ...
                <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalLongTitle">Supprimer un prix parc</h5>
                ...
                <div className="modal-body" style={modalStyle.body}>
                    <div style={modalStyle.content_form}>
                        <p style={{color:'red'}}>Voulez vous vraiment supprimer ce prix parc ?</p>
                    </div>
                </div>
...
export default DeletePrixParcModal