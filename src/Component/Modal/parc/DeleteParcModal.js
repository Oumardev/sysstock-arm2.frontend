...
import { deleteParc } from '../../../slices/userSlice'
...
const DeleteParcModal = ({dataModal: {id}, setShowModal}) =>{

    const dispatch = useDispatch()

    const handleDelete = () =>{
        
        dispatch(deleteParc(id))
        setShowModal(false)
        ...
        <React.Fragment>
            ...
            <div className="modal-dialog modal-dialog-centered" role="document">
                ...
                <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalLongTitle">Supprimer un parc</h5>
                ...
                <div className="modal-body" style={modalStyle.body}>
                    <div style={modalStyle.content_form}>
                        <p style={{color:'red'}}>Voulez vous vraiment supprimer ce parc ?</p>
                    </div>
                </div>
...
export default DeleteParcModal