...
import { parcSelector, editPrixParc } from "../../../slices/parcSlice";
...
function EditPrixParcModal({dataModal : { id ,variete, parc, prix_bascule, prix_sac, quantite_stockee } ,setShowModal}) {

    const { ls_variete , ls_parc} = useSelector(parcSelector)
    ...
    const editPrixParcSchema = Yup.object().shape({
        variete: Yup.string()
        .min(1, 'Trop court!')
        .max(100, 'Trop long!')
        ...
        <React.Fragment>
            ...
            <div className="modal-dialog" role="document">
                ...
                <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalLabel">Modifier un prix parc</h5>
                ...
                <Formik
                    initialValues={{ 
                        ...
                        variete: variete.nom ?? '', 
                        parc: parc.nom ?? '', 
                        prix_bascule: prix_bascule, 
                        prix_sac: prix_sac, 
                        quantite_stocke : quantite_stockee
                    }}
                    
                    validationSchema = {editPrixParcSchema}
...
export default EditPrixParcModal