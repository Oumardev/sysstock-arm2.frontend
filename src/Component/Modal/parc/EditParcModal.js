...
function EditMarcheModal({dataModal :{ id, nom , zone } ,setShowModal, RegionDepartementCommune , ls_zone}) {
    ...
    const editParcSchema = Yup.object().shape({
        nom: Yup.string()
        ...
        <React.Fragment>
            ...
            <div className="modal-dialog" role="document">
                ...
                <div className="modal-header">
                    <h5 className="modal-title" id="exampleModalLabel">Modifier un parc</h5>
                ...
                <Formik
                    ...
                    validationSchema = {editParcSchema}
                    ...
                    onSubmit={(values, { setSubmitting }) => {
                        ...
                        const formatData = {id: values.id ,nom: values.nom, zone_id: zone_id}
                        
                        // edit parc
                        dispatch(editParc(formatData))
                        setShowModal(false)
